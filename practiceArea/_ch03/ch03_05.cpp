...
void delHead(class list **dataList) {
    class list *ptr = *dataList;

    (*dataList) = (*dataList)->next;

    cout << "Remove head: " << ptr->data << ": " << ptr->letters << endl;
    free(ptr);
}

void delTail(class list **dataList) {

    class list *ptrTail = *dataList;
    ...
    class list *ptr = *dataList;
    while(ptr->next != ptrTail) {
        ptr = ptr->next;
    }

    ptr->next = NULL;

    cout << "Remove head: " << ptrTail->data << ": " << ptrTail->letters << endl;
    free(ptrTail);
}

void delSel(class list **dataList, int position) {
    ...
    class list *ptrTemp = ptr->next;
    ptr->next = ptr->next->next;
    cout << "Remove position node: " << position << " -> " << ptrTemp->data << ": " << ptrTemp->letters << endl;
    free(ptrTemp);
