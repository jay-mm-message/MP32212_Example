...
void show(vector<int> vec, int sort_mode);
...
int main() {
    ...
    show(vec, sort_from_small_to_large);

    insertion_sort(vec, sort_from_large_to_smal);
    show(vec, sort_from_large_to_smal);
...
void show(vector<int> vec, int sort_mode) {
    ...
    switch (sort_mode)
    {
    case sort_from_large_to_smal:
        cout << "sort_from_large_to_smal" << endl;
        break;
     case sort_from_small_to_large:
        cout << "sort_from_small_to_large" << endl;
        break;   
    default:
        cout << "no sort" << endl;
        break;
